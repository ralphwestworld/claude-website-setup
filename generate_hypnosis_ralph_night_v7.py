...
SEGMENTS = [
    ...
    # === NEW: Abundance / Lakefront Mansion (wealth lifestyle visualization) ===
    {
        ...
        "text": (
            ...
            "Now see your home. <<5>>\n\n"
            "Sixty Kensington Oval. Rocky River, Ohio. <<3>> This is your address. This is your home. <<5>>\n\n"
            "You drive down Kensington Oval, and you pull into your driveway. <<3>> The Erie lakefront is right there. The water stretches out before you. Blue. Vast. Calm. <<5>>\n\n"
            "The house is yours. <<3>> Beautiful. Exactly the home you wanted. <<3>> Big windows. Light pouring in. <<5>>\n\n"
            "You pull into the garage. <<3>> Your cars. Yours. <<3>> Each one chosen by you. <<3>> The space is wide. Clean. Organized. <<5>>\n\n"
